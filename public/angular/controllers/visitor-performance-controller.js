/*angular.module('app')
  .controller('VisitorPerformanceController' , ['$scope', function($scope) {
  ...
  (function() {
      ...
      angular
        .module('app')
        .controller('VisitorPerformanceController', Chart);
        ...
        function Chart($scope){
          ...
          vm.p_l_2 = [['Lun', 5.5], ['Mar', 5.7], [3, 6.4], [4, 7.0], [5, 7.2], [6, 7.3], [7, 7.5]];
          ...
          vm.p_b_2 = [[5, 18], [20, 30], [18, 40], [12, 50], [3, 60]];
